...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-logo layuimini-logo">666</div>
        ...
        var options = {
            <c:choose>
                <c:when test="${sessionScope.type.equals('reader')}">
                    iniUrl: "${pageContext.request.contextPath}/api/init2.json",//初始化接口，读者页面
                </c:when>
                <c:otherwise>
                    iniUrl: "${pageContext.request.contextPath}/api/init.json",//初始化接口，管理员页面
                </c:otherwise>
            </c:choose>
